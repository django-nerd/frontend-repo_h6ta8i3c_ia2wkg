...
import { Menu, User, LogOut, LogIn, PlusCircle, Search, TrendingUp, MessageSquare, Shield, Settings, BadgeDollarSign, Video } from 'lucide-react'
    ...
    <header className="sticky top-0 z-50 backdrop-blur bg-black/50 border-b border-blue-900/40">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between text-white">
        <Link to="/" className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500/80 to-blue-700/60 border border-blue-400/30 shadow-inner"></div>
        ...
        <div className="space-y-4">
          {posts.map(p=> (
            <div key={p.id} className="rounded-2xl border border-blue-900/50 bg-gradient-to-b from-slate-900 to-black p-5">
              ...
              <p className="text-blue-200/90 text-sm mb-4 whitespace-pre-wrap">{p.content}</p>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="rounded-2xl border border-blue-900/50 p-5 bg-gradient-to-b from-slate-900 to-black">
            ...
            <p className="text-sm text-blue-200/80">Update your info and age.</p>
          </div>
          <div className="rounded-2xl border border-blue-900/50 p-5 bg-gradient-to-b from-slate-900 to-black">
            <div className="font-semibold mb-2">2FA</div>
            <p className="text-sm text-blue-200/80">Scan QR to enable two-factor authentication.</p>
          </div>
        </div>
      </div>
    </div>
